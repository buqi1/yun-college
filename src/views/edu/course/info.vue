  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
        ...
        <el-form-item label="总课时">
            <el-input-number :min="0" v-model="courseVO.lessonNum" controls-position="right" placeholder="请填写课程的总课时数"/>
        </el-form-item>
        ...
        <el-form-item label="课程价格">
            <el-input-number :min="0" v-model="courseVO.price" controls-position="right" placeholder="免费课程请设置为0元"/> 元
        </el-form-item>
...
export default {
    ...
    methods:{
        //根据课程id查询
        getInfo() {
            course.getcourseVOId(this.courseId)
                .then(response => {
                    //在courseVO课程基本信息，包含 一级分类id 和 二级分类id
                    ...
                    subject.getSubjectList()
                        .then(response => {
                            ...
                            for(var i=0;i<this.subjectOneList.length;i++) {
                                ...
                                //比较当前courseVO里面一级分类id和所有的一级分类id
        ...
        //添加课程
        addCourse() {
            course.addCourse(this.courseVO)
                .then(response => {
                    //提示
                    this.$message({
                        type: 'success',
        ...
        //修改课程
        updateCourse() {
            course.updateCourseVO(this.courseVO)
                .then(response => {
                     //提示
                    this.$message({
                        type: 'success',
